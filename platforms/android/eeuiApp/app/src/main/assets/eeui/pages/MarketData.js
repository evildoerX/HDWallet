...
__vue_options__.__file = "/Users/ch/BlockChain/HDWallet/src/pages/MarketData.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-76cd4caa"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _MarketItem = __webpack_require__(6);

var _MarketItem2 = _interopRequireDefault(_MarketItem);

var _MarketListTitle = __webpack_require__(10);
...
exports.default = {
  ...
  methods: {
    ...
    getMarketData: function getMarketData(type) {
      var _this = this;
      ...
      _Http2.default.postData("/market/item", postData).then(function (res) {
        _this.marketData = res.items;
      });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["marketdata"]
  }, [_c('MarketListTitle'), _c('scroll-view', {
    staticClass: ["marketdata-list"]
